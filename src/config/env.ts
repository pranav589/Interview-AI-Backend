...
const envSchema = z.object({
  ...
  EMAIL_USER: z.string().min(1), // user asked for EMAIL_USER
  EMAIL_PASS: z.string().min(1), // user asked for EMAIL_PASS
  ...
  // Google OAuth (found in .env, adding for completeness)
